...
public class MdpSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    static {
        ...
        fillMap(ATTRIBUTES, WIKI_LINK_TEXT_START_SET, WIKI_LINK_TEXT_START_ATTR_KEY);
        fillMap(ATTRIBUTES, WIKI_LINK_TEXT_SET, WIKI_LINK_TEXT_ATTR_KEY);
        fillMap(ATTRIBUTES, WIKI_LINK_TEXT_END_SET, WIKI_LINK_TEXT_END_ATTR_KEY);
        fillMap(ATTRIBUTES, WIKI_LINK_REF_START_SET, WIKI_LINK_REF_START_ATTR_KEY);
        fillMap(ATTRIBUTES, WIKI_LINK_REF_SET, WIKI_LINK_REF_ATTR_KEY);
        fillMap(ATTRIBUTES, WIKI_LINK_REF_END_SET, WIKI_LINK_REF_END_ATTR_KEY);
    }
